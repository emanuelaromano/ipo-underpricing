...
def rebalance(filename):
    ...
    print(f'the initial sampled development data has a distribution of {y_dev.shape[0]}')
    print(f'the random over sampled development data has a distribution of {y_dev_samp_s.shape[0]}')
    print(f'the random over sampled development set has a shape of {y_dev_samp_s.shape}')
...
if __name__ == '__main__':
    ...
    show_correlation('Encoded_data.csv','Clean_Encode.csv')
    checkimbalance('Clean_Encode.csv')
    rebalance('Clean_Encode.csv')
    pass
