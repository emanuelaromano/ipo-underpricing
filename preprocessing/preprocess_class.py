...
def rebalance(filename):
    ...
    df_final.to_csv('Final_Output_Class_resampled.csv',index=False)
...
if __name__ == '__main__':
    ...
    show_correlation('Encoded_data.csv','Final_Output_Class.csv')
    checkimbalance('Final_Output_Class.csv')
    rebalance('Final_Output_Class.csv')
